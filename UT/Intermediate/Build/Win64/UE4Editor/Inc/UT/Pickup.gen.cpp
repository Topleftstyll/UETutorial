...
// Cross Module References
	UT_API UFunction* Z_Construct_UFunction_APickup_OnPlayerEnterPickupBox();
...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_APickup()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_APickup_OnPlayerEnterPickupBox(), "OnPlayerEnterPickupBox"); // 2793444749
	...
	IMPLEMENT_CLASS(APickup, 288931777);
